...
import easyphone.linphone.KeepAliveHandler;
import easyphone.linphone.LinphoneManager;
...
//            mWakeLock = null;
//        }
//        ((AlarmManager)LinphoneService.getSystemService(Context.ALARM_SERVICE)).cancel(mKeepAlivePendingIntent);
    }
    ...
    public static void addRegistrationCallback(RegistrationCallback registrationCallback) {
        io.flutter.Log.e("初始化上线的callback","初始化了。。。");
    ...
    public void registrationState(LinphoneCore linphoneCore, LinphoneProxyConfig linphoneProxyConfig,
        ...
        io.flutter.Log.e("初始化上线的callback","初始化了。。。"+sRegistrationCallback);
